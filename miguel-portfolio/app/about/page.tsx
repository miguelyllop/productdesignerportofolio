export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-6">About Miguel</h1>
      <div className="prose lg:prose-xl dark:prose-invert">
        <p>
          Miguel is a passionate product designer with a keen eye for detail and a user-centered approach. 
          With years of experience in the field, Miguel has developed a strong portfolio of projects that 
          demonstrate his ability to create intuitive and visually appealing user interfaces.
        </p>
        <p>
